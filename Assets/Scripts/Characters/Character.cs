...
{
    // COMMON CHARACTERISTICS OF CHARACTERS, IE NPCS AND PLAYER
    ...
    public IEnumerator Move(Vector2 moveVec, Action OnMoveOver=null)
    {
        ...
        // Set the space where we'd move to
    ...
    public void LookTowards(Vector3 targetPos)
    {
        ...
        if (xdiff == 0 || ydiff == 0)
        {
            ...
            Debug.LogError("Error in Look Towards: You can't ask a character to look diagonally");
    }
